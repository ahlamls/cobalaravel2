...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="caption" required="" name="caption" placeholder="Describe the image">
</div>
<div class="mb-3">
...
<label class="text-muted">By Clicking the Upload Button . you are agreeing to the Terms of Service of the site</label>
</form>
